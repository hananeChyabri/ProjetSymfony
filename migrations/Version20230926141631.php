 ...
 */
final class Version20230926141631 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE plante_profil ADD CONSTRAINT FK_7161D0D8A76ED395 FOREIGN KEY (user_id) REFERENCES `user` (id)');
        $this->addSql('ALTER TABLE plante_profil ADD CONSTRAINT FK_7161D0D8177B16E8 FOREIGN KEY (plante_id) REFERENCES plante (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE plante_profil DROP FOREIGN KEY FK_7161D0D8A76ED395');
        $this->addSql('ALTER TABLE plante_profil DROP FOREIGN KEY FK_7161D0D8177B16E8');
        $this->addSql('DROP TABLE image');
        $this->addSql('DROP TABLE plante');
        $this->addSql('DROP TABLE plante_profil');
